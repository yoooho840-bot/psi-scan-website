...
반드시 아래의 JSON 구조만을 반환해야 하며, 기타 텍스트는 출력하지 마십시오:
{
  ...
  "sub_bot_c_argument": "[법률 자문] 해당 안건의 '비즈니스 리스크, 의료법 한계, 법적 경계'를 아주 차갑고 단호하게 짚어주는 발언.",
  "orchestrator_conclusion": "[마스터 봇] 세 서브 봇의 통찰과 경고를 종합하여 원장님께 가장 완벽한 해법을 제안하는 최종 결론."
}
`;
